  ...
  return (
    <header className="w-full py-5">
      <div className="justify-between mycontainer flex-wrap items-center lg:p-0  px-4 h-full flex">
        ...
        <div className="justify-end flex sm:w-[40%] w-[60%]">
          <div className="justify-between border border-gray-400 p-1 sm:mr-[30px] mr-2 rounded border-solid  flex">
          ...
          <div>
            <NavLink to="/login" className="bg-[#e50914] block hover:bg-[#e50914de] p-1 text-white rounded-sm w-[76px] h-full">
              Sign In
            </NavLink>
          </div>
        </div>
